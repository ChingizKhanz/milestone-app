package edu.gcu.cst239.askarov.chingiz.milestone_app.util;
...
public class InputUtilities {
     ...
     * Each nonempty line is added to the list.  Useful when
     * collecting a list of ingredients or similar multivalue fields.
     *
